...
function helloWorld2(){
    ...
    return 'hello world 2' // 함수 내부는 return을 만난 순간 끝이므로 25번째 줄은 출력되지 않는다.
    console.log('리턴 아래 입니다..')
}
...
console.log(sayHello2("안녕", "haeri"))
...
const sayHelloValue=sayHello4("안녕","혜리")
console.log(sayHelloValue)

console.log("----실습 함수 만들기01----")
